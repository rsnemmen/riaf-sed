...
! if there is no outflow, this value does not affect the spectrum.
	...
	open(23,file='dspa3d-5.dat')
!	open(23,file='s5.dat')
	open(24,file='ses5.dat')
        open(13,file='dga3d-5.dat')
!        open(13,file='2-3.dat')
	open(14,file='hot7.dat')
...
50      format(2e15.6)
	...
	print*,'the totoal luminosity is: ',totlu
