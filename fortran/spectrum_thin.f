...
c------------------------------------------------------------------
        do 30 j=1,nvmax
c *** The first term in the exponent is the lower frequency limit in the spectrum
c   (previously was 10.1, now is 9.0)
        nnu(j)=10.d0**(9.0+0.15d0*j)	!----------------------(8)------------------
...
c *** The three lines below were commented out.

        sup=5.d0*rtran/6.77d-12*m
        slow=rtran/6.77d-12*m
	call simp(slow,sup,10,fbb,hh,radaf,tau,nunu)
