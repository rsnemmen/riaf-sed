...
c ** hangproof
	double precision bessel1,bessel2,bessel3,bessel4
	dimension y(4),dy(4)
	common alfa,beta,dotm0,rout,p0,gamai,ru,
     $          sl0,m,mui,mue,delta,rtran
c ------------------------------------
...
c	print *, 'R=',y(1)
	bessel3=mbsl4(1,bel)
c	print *, 'Bessel3=',bessel3		
	bessel2=mbsl4(2,1.d0/setai)
c	print *, 'Bessel2=',bessel2	
	bessel1=mbsl4(2,1.d0/setae)
c	print *, 'Bessel1=',bessel1	
	bessel4=mbsl4(0,bel)
c	print *, 'Bessel4=',bessel4	
c	differ=abs(rold-y(1))
c	if (differ .le. 1e-7 .AND. differ .ne. 0.) goto 17
c	rold=y(1)	
        qie=2.366*20.d0/m*rho*rho*(y(4)-y(3))/bessel1
     $          /bessel2*((2.*(setae+setai)**2.d0+1.)/
     $          (setae+setai)*bessel3+2.*bessel4)
c	print *, 'qie=',qie	
...
c ** Lines of code added to avoid the hanging of the code are labelled with HANGPROOF
c	rold=y(1)
