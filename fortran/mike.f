...
c Test for unphysical (i.e. negative) temperatures *********************

	if (y(3).le.0.) write(*,*) '*** Negative T_e: ',y(3)
	if (y(4).le.0.) write(*,*) '*** Negative T_i: ',y(4)

c Modified the standard output **
	    write(*,500) y(1),-y(2)/cs/aaa,log10(y(3))
     $	        ,log10(y(4)),advec,advec2,cs,dh,qn,tau,log10(slk)
     $		,log10(ssll),bb
c    $		log10(m*rho/1.01d-63*6.77d-12**3.d0/m**3.d0)
 500        format(13(1x,1pe10.3))
